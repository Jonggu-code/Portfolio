              ...
              <div className="w-1/2 h-[294px] px-5 mt-5 flex flex-wrap content-between">
                ...
                <div className="absolute top-[20px] right-[20px] flex gap-2">
                  <a
                    ...
                    target="_blank"
                    className="group hover:-translate-y-1 transition-all duration-300 w-full text-center"
                  >
              ...
              <div className="w-1/2 h-[294px] px-5 mt-5 flex flex-wrap content-between">
                <div className="w-full">
                  <h1 className="text-[15px] pb-5">
                    사람들이 맛집을 검색함에 있어 가장 원하는 정보, 정제된
                    정보를 전달해주는 사이트를 제작했습니다.
                  </h1>
                  <h2 className="text-[15px] pb-5">
                    팀 프로젝트를 진행하며 <strong>협업과 소통의 중요성</strong>
                    을 느꼈고 <strong>데이터 크롤링, 카카오맵 API 활용</strong>
                    을 경험했습니다.
                  </h2>
                </div>
                <div>
          ...
          >
            ...
            <div className="projectBox flex w-full h-[320px]">
              ...
              <div className="w-1/2 h-[294px] px-5 mt-5 flex flex-wrap content-between">
                <div className="w-full">
                  <h1 className="text-[15px] pb-3">
                    유튜브 뮤직 클론 코딩을 진행습니다. UI/UX 적으로 개선되면
                    좋을 것 같다고 생각한 부분을 개선해 봤습니다.
                  </h1>
                  <h2 className="text-[15px] pb-5">
                    <strong>
                      Javascript, jquery의 코드 숙련도가 상승하였고, 미디어
                      제어, 반응형 웹페이지
                    </strong>{" "}
                    제작 방법에 대한 공부가 되었습니다.
                  </h2>
